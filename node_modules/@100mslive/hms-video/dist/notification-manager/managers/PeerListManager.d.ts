...
import { PeerListNotification } from '../HMSNotifications';
...
export declare class PeerListManager {
    ...
    private get TAG();
    handleInitialPeerList: (peerList: PeerListNotification) => void;
    handleReconnectPeerList: (peerList: PeerListNotification) => void;
