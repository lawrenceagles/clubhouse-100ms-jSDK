...
var HMSRemoteStream = /*#__PURE__*/function (_HMSMediaStream) {
  ...
  function HMSRemoteStream(nativeStream, connection) {
    ...
    _this.audio = true;
    _this.video = HMSSimulcastLayer.NONE;
...
var HMSRemoteVideoTrack = /*#__PURE__*/function (_HMSVideoTrack) {
  ...
  _proto.updateLayer = function updateLayer() {
    var newLayer = this.hasSinks() ? HMSSimulcastLayer.HIGH : HMSSimulcastLayer.NONE;
...
var parsedUserAgent = /*#__PURE__*/new UAParser();
                ...
                return runtime_1.wrap(function _loop$(_context14) {
                  while (1) {
                    switch (_context14.prev = _context14.next) {
                      ...
                      case 17:
                        if (!(plugin.getPluginType() === HMSVideoPluginType.ANALYZE && !skipProcessing)) {
                          _context14.next = 20;
                          break;
                        }
...
var ActiveSpeakerManager = /*#__PURE__*/function () {
  ...
  _proto.handleActiveSpeakers = function handleActiveSpeakers(speakerList) {
    ...
    if (dominantSpeaker) {
      ...
      (_this$listener = this.listener) == null ? void 0 : _this$listener.onPeerUpdate(HMSPeerUpdate.BECAME_DOMINANT_SPEAKER, dominantSpeakerPeer);
    } else {
      var _this$listener2;

      (_this$listener2 = this.listener) == null ? void 0 : _this$listener2.onPeerUpdate(HMSPeerUpdate.RESIGNED_DOMINANT_SPEAKER, null);
    }
  };
        ...
        if (oldPeer) {
          ...
          tracks.forEach(function (track) {
            if (!newPeerNotification.tracks.hasOwnProperty(track.trackId)) {
              ...
              (_this$listener = _this.listener) == null ? void 0 : _this$listener.onTrackUpdate(HMSTrackUpdate.TRACK_REMOVED, track, oldPeer);
            }
...
var PeerManager = /*#__PURE__*/function () {
  function PeerManager(store, trackManager, listener) {
    ...
    this.handlePeerList = function (peers) {
      ...
      (_this$listener = _this.listener) == null ? void 0 : _this$listener.onPeerUpdate(HMSPeerUpdate.PEER_LIST, hmsPeers);
    ...
    this.handlePeerJoin = function (peer) {
      ...
      (_this$listener2 = _this.listener) == null ? void 0 : _this$listener2.onPeerUpdate(HMSPeerUpdate.PEER_JOINED, hmsPeer);
    ...
    this.handlePeerLeave = function (peer) {
      ...
      if (hmsPeer.audioTrack) {
        ...
        (_this$listener3 = _this.listener) == null ? void 0 : _this$listener3.onTrackUpdate(HMSTrackUpdate.TRACK_REMOVED, hmsPeer.audioTrack, hmsPeer);
      }

      if (hmsPeer.videoTrack) {
        var _this$listener4;

        (_this$listener4 = _this.listener) == null ? void 0 : _this$listener4.onTrackUpdate(HMSTrackUpdate.TRACK_REMOVED, hmsPeer.videoTrack, hmsPeer);
      }

      (_hmsPeer$auxiliaryTra = hmsPeer.auxiliaryTracks) == null ? void 0 : _hmsPeer$auxiliaryTra.forEach(function (track) {
        var _this$listener5;

        (_this$listener5 = _this.listener) == null ? void 0 : _this$listener5.onTrackUpdate(HMSTrackUpdate.TRACK_REMOVED, track, hmsPeer);
      });
      (_this$listener6 = _this.listener) == null ? void 0 : _this$listener6.onPeerUpdate(HMSPeerUpdate.PEER_LEFT, hmsPeer);
    };
  }
  ...
  _proto.handlePeerUpdate = function handlePeerUpdate(notification) {
    ...
    if (peer.role && peer.role.name !== notification.role) {
      ...
      (_this$listener7 = this.listener) == null ? void 0 : _this$listener7.onPeerUpdate(HMSPeerUpdate.ROLE_UPDATED, peer);
    }
  };
...
var RoomUpdateManager = /*#__PURE__*/function () {
  ...
  _proto.onPeerList = function onPeerList(notification) {
    ...
    (_this$listener = this.listener) == null ? void 0 : _this$listener.onRoomUpdate(HMSRoomUpdate.RECORDING_STATE_UPDATED, room);
  };
  ...
  _proto.setRTMPStatus = function setRTMPStatus(running) {
    ...
    (_this$listener3 = this.listener) == null ? void 0 : _this$listener3.onRoomUpdate(HMSRoomUpdate.RTMP_STREAMING_STATE_UPDATED, room);
  };
...
var TrackManager = /*#__PURE__*/function () {
  function TrackManager(store, eventEmitter, listener) {
    ...
    this.handleTrackRemove = function (track) {
      ...
      track.type === HMSTrackType.AUDIO && _this.eventEmitter.emit('track-removed', {
        detail: track
      });
      ...
      (_this$listener = _this.listener) == null ? void 0 : _this$listener.onTrackUpdate(HMSTrackUpdate.TRACK_REMOVED, track, hmsPeer);
    };
        ...
        if (!track || _this.tracksToProcess.has(trackId)) {
          ...
          if (currentTrackStateInfo.mute !== trackEntry.mute) {
            if (trackEntry.mute) {
              ...
              (_this$listener2 = _this.listener) == null ? void 0 : _this$listener2.onTrackUpdate(HMSTrackUpdate.TRACK_MUTED, track, hmsPeer);
            } else {
              var _this$listener3;

              (_this$listener3 = _this.listener) == null ? void 0 : _this$listener3.onTrackUpdate(HMSTrackUpdate.TRACK_UNMUTED, track, hmsPeer);
            }

            track.type === HMSTrackType.AUDIO && _this.eventEmitter.emit('track-updated', {
              detail: {
                track: track,
            ...
            (_this$listener4 = _this.listener) == null ? void 0 : _this$listener4.onTrackUpdate(HMSTrackUpdate.TRACK_DESCRIPTION_CHANGED, track, hmsPeer);
          }
        }
      }
    };
  ...
  _proto.processPendingTracks = function processPendingTracks() {
    ...
    tracksCopy.forEach(function (track) {
      ...
      track.type === HMSTrackType.AUDIO ? _this2.eventEmitter.emit('track-added', {
        detail: {
          track: track,
          peer: hmsPeer
        }
      }) : (_this2$listener = _this2.listener) == null ? void 0 : _this2$listener.onTrackUpdate(HMSTrackUpdate.TRACK_ADDED, track, hmsPeer);
...
var AudioSinkManager = /*#__PURE__*/function () {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 13:
                ...
                track.removeSink();
                (_this$listener = _this.listener) == null ? void 0 : _this$listener.onTrackUpdate(HMSTrackUpdate.TRACK_ADDED, track, peer);
                return _context2.abrupt("return");
              ...
              case 22:
                (_this$listener2 = _this.listener) == null ? void 0 : _this$listener2.onTrackUpdate(HMSTrackUpdate.TRACK_ADDED, track, peer);
                /**
  ...
  _proto.init = function init(elementId) {
    ...
    audioSink.id = "HMS-SDK-audio-sink-" + v4();
  ...
  _proto.getTrackComparators = function getTrackComparators() {
    ...
    return {
      video: function video(trackA, trackB) {
        return _this2.primitiveComparator(trackA.type === HMSTrackType.VIDEO, trackB.type === HMSTrackType.VIDEO);
      },
      audio: function audio(trackA, trackB) {
        return _this2.primitiveComparator(trackA.type === HMSTrackType.AUDIO, trackB.type === HMSTrackType.AUDIO);
      },
...
var Store = /*#__PURE__*/function () {
  ...
  _proto.getAudioTracks = function getAudioTracks() {
    return this.getTracks().filter(function (track) {
      return track.type === HMSTrackType.AUDIO;
    });
  };
        ...
        return runtime_1.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 15:
                (_this$listener = _this.listener) == null ? void 0 : _this$listener.onPeerUpdate(HMSPeerUpdate.ROLE_UPDATED, localPeer);
          ...
          switch (_context2.prev = _context2.next) {
            ...
            case 9:
              for (_i = 0, _tracksToUnpublish = tracksToUnpublish; _i < _tracksToUnpublish.length; _i++) {
                ...
                (_this$listener2 = this.listener) == null ? void 0 : _this$listener2.onTrackUpdate(HMSTrackUpdate.TRACK_REMOVED, track, localPeer);
              }
          ...
          switch (_context.prev = _context.next) {
            ...
            case 12:
              ...
              videoTrack = localTracks.find(function (t) {
                return t.type === HMSTrackType.VIDEO && t.source === 'regular';
              });
              audioTrack = localTracks.find(function (t) {
                return t.type === HMSTrackType.AUDIO && t.source === 'regular';
              });
              screenTrack = localTracks.find(function (t) {
                return t.type === HMSTrackType.VIDEO && t.source === 'screen';
...
var PlaylistManager = /*#__PURE__*/function (_TypedEventEmitter) {
    ...
    var _setEnabled = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee3(enabled, _ref3) {
      ...
      return runtime_1.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              id = _ref3.id, _ref3$type = _ref3.type, type = _ref3$type === void 0 ? HMSPlaylistType.audio : _ref3$type;
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              manager = type === HMSPlaylistType.audio ? this.audioManager : this.videoManager;
              _context6.next = 4;
  ...
  _proto.onProgress = function onProgress(fn) {
    ...
    this.videoManager.on('progress', function () {
      try {
        fn({
          ...
          progress: _this3.getCurrentProgress(HMSPlaylistType.video)
        });
      } catch (error) {
    ...
    this.audioManager.on('progress', function () {
      try {
        fn({
          type: HMSPlaylistType.audio,
          progress: _this3.getCurrentProgress(HMSPlaylistType.audio)
        });
      } catch (error) {
        HMSLogger.e(_this3.TAG, 'Error in onProgress callback');
      }
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            ...
            case 21:
              ...
              track = _step2.value;
              _context8.next = 25;
              return this.addTrack(track, type === HMSPlaylistType.audio ? 'audioplaylist' : 'videoplaylist');
  ...
  _proto.addListeners = function addListeners() {
    ...
    this.audioManager.on('ended', function () {
      return _this4.handleEnded(HMSPlaylistType.audio);
    });
    this.videoManager.on('ended', function () {
      return _this4.handleEnded(HMSPlaylistType.video);
    });
  }
  /**
  ...
  function HMSSdk() {
    ...
    this.observer = {
      ...
      onTrackDegrade: function onTrackDegrade(track) {
        ...
        (_this$listener = _this.listener) == null ? void 0 : _this$listener.onTrackUpdate(HMSTrackUpdate.TRACK_DEGRADED, track, (_this$store = _this.store) == null ? void 0 : _this$store.getPeerByTrackId(track.trackId));
      },
      onTrackRestore: function onTrackRestore(track) {
        ...
        (_this$listener2 = _this.listener) == null ? void 0 : _this$listener2.onTrackUpdate(HMSTrackUpdate.TRACK_RESTORED, track, (_this$store2 = _this.store) == null ? void 0 : _this$store2.getPeerByTrackId(track.trackId));
      },
      onFailure: function onFailure(exception) {
    ...
    this.handleDeviceChangeError = function (event) {
      ...
      if (event.error && event.type) {
        ...
        if ([ErrorCodes.TracksErrors.CANT_ACCESS_CAPTURE_DEVICE, ErrorCodes.TracksErrors.DEVICE_IN_USE, ErrorCodes.TracksErrors.DEVICE_NOT_AVAILABLE].includes(event.error.code) && track) {
          ...
          (_this$listener6 = _this.listener) == null ? void 0 : _this$listener6.onTrackUpdate(HMSTrackUpdate.TRACK_MUTED, track, _this.localPeer);
        }
      }
    };
  }
          ...
          switch (_context10.prev = _context10.next) {
            ...
            case 32:
              tracks.forEach(function (track) {
                ...
                (_this4$listener = _this4.listener) == null ? void 0 : _this4$listener.onTrackUpdate(HMSTrackUpdate.TRACK_ADDED, track, _this4.localPeer);
              });
        ...
        while (1) {
          switch (_context13.prev = _context13.next) {
            ...
            case 26:
              ...
              (_this$listener7 = this.listener) == null ? void 0 : _this$listener7.onTrackUpdate(HMSTrackUpdate.TRACK_ADDED, hmsTrack, this.localPeer);
        ...
        while (1) {
          switch (_context14.prev = _context14.next) {
            ...
            case 7:
              ...
              (_this$listener8 = this.listener) == null ? void 0 : _this$listener8.onTrackUpdate(HMSTrackUpdate.TRACK_REMOVED, track, this.localPeer);
              _context14.next = 12;
              break;
        ...
        while (1) {
          switch (_context24.prev = _context24.next) {
            ...
            case 5:
              ...
              (_this$listener9 = this.listener) == null ? void 0 : _this$listener9.onTrackUpdate(HMSTrackUpdate.TRACK_ADDED, track, this.localPeer);
...
export { HMSAudioCodec, HMSAudioPluginType, HMSAudioTrack, HMSException, HMSLocalAudioTrack, HMSLocalVideoTrack, HMSLogLevel, HMSPeerUpdate, HMSPlaylistType, HMSRemoteAudioTrack, HMSRemoteVideoTrack, HMSRoomType, HMSRoomUpdate, HMSSdk, HMSSimulcastLayer, HMSTrack, HMSTrackType, HMSTrackUpdate, HMSVideoCodec, HMSVideoPluginType, HMSVideoTrack, getLocalDevices, getLocalScreen, getLocalStream, isBrowser, isMobile, isNode, isSupported, parsedUserAgent, userAgent, validateDeviceAV };
//# sourceMappingURL=hms-video.esm.js.map
