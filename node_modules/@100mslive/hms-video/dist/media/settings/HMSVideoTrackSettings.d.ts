...
export declare class HMSVideoTrackSettings implements IHMSVideoTrackSettings, IAnalyticsPropertiesProvider {
    ...
    constructor(width: number, height: number, codec: HMSVideoCodec, maxFramerate: number, deviceId: string | undefined, advanced: Array<MediaTrackConstraintSet>, maxBitrate?: number);
