...
import { HMSRemoteAudioTrack, HMSRemoteVideoTrack, HMSLocalVideoTrack, HMSLocalAudioTrack, HMSLogLevel, HMSPeerUpdate, HMSTrackUpdate, HMSAudioTrack, HMSSdk } from '@100mslive/hms-video';
export { HMSLogLevel, HMSSimulcastLayer } from '@100mslive/hms-video';
...
var SDKToHMS = /*#__PURE__*/function () {
  ...
  SDKToHMS.enrichTrack = function enrichTrack(track, sdkTrack) {
    ...
    if (sdkTrack instanceof HMSRemoteAudioTrack) {
  ...
  SDKToHMS.enrichVideoTrack = function enrichVideoTrack(track, sdkTrack) {
    if (sdkTrack instanceof HMSRemoteVideoTrack) {
  ...
  SDKToHMS.enrichPluginsDetails = function enrichPluginsDetails(track, sdkTrack) {
    if (sdkTrack instanceof HMSLocalVideoTrack || sdkTrack instanceof HMSLocalAudioTrack) {
  ...
  SDKToHMS.convertPlaylist = function convertPlaylist(playlistManager) {
    var audioPlaylist = this.getConvertedPlaylistType(playlistManager, HMSPlaylistType.audio);
    var videoPlaylist = this.getConvertedPlaylistType(playlistManager, HMSPlaylistType.video);
    return {
      audio: audioPlaylist,
      video: videoPlaylist
    };
...
var selectIsConnectedToRoom = /*#__PURE__*/createSelector([selectRoom], function (room) {
  return room && room.isConnected;
});
var selectPeerCount = /*#__PURE__*/createSelector(selectRoom, function (room) {
...
var selectPeers = /*#__PURE__*/createSelector([selectRoom, selectPeersMap], function (room, storePeers) {
...
var selectTracks = /*#__PURE__*/createSelector(selectTracksMap, function (storeTracks) {
...
var selectLocalPeer = /*#__PURE__*/createSelector(selectRoom, selectPeersMap, function (room, peers) {
...
var selectLocalPeerID = /*#__PURE__*/createSelector(selectRoom, function (room) {
...
var selectLocalAudioTrackID = /*#__PURE__*/createSelector(selectLocalPeer, function (peer) {
...
var selectLocalVideoTrackID = /*#__PURE__*/createSelector(selectLocalPeer, function (peer) {
...
var selectLocalAuxiliaryTrackIDs = /*#__PURE__*/createSelector(selectLocalPeer, function (peer) {
...
var selectLocalTrackIDs = /*#__PURE__*/createSelector([selectLocalAudioTrackID, selectLocalVideoTrackID, selectLocalAuxiliaryTrackIDs], function (audioTrackID, videoTrackID, auxiliaryTrackIDs) {
...
var selectRemotePeers = /*#__PURE__*/createSelector(selectPeers, function (peers) {
...
var selectDominantSpeaker = /*#__PURE__*/createSelector(selectPeersMap, selectSpeakers, function (peersMap, speakers) {
...
var selectIsLocalScreenShared = /*#__PURE__*/createSelector(selectLocalPeer, selectTracksMap, function (localPeer, tracksMap) {
...
var selectPeerScreenSharing = /*#__PURE__*/createSelector(selectPeersMap, selectTracksMap, function (peersMap, tracksMap) {
...
var selectIsSomeoneScreenSharing = /*#__PURE__*/createSelector(selectPeerScreenSharing, function (peer) {
  return !!peer;
});
/**
...
var selectPeerSharingAudio = /*#__PURE__*/createSelector(selectPeersMap, selectTracksMap, function (peersMap, tracksMap) {
  for (var peerID in peersMap) {
    var peer = peersMap[peerID];
...
var selectPeersScreenSharing = /*#__PURE__*/createSelector(selectPeersMap, selectTracksMap, function (peersMap, tracksMap) {
  var videoPeers = [];
  var audioPeers = [];
...
var selectPeerSharingVideoPlaylist = /*#__PURE__*/createSelector(selectPeersMap, selectTracksMap, function (peersMap, tracksMap) {
  for (var peerID in peersMap) {
    var peer = peersMap[peerID];
...
var selectDegradedTracks = /*#__PURE__*/createSelector(selectTracks, function (tracks) {
...
var selectHMSMessagesCount = /*#__PURE__*/createSelector(selectMessageIDsInOrder, function (messageIDs) {
...
var selectUnreadHMSMessagesCount = /*#__PURE__*/createSelector(selectMessagesMap, function (messages) {
...
var selectHMSMessages = /*#__PURE__*/createSelector(selectMessageIDsInOrder, selectMessagesMap, function (msgIDs, msgMap) {
  var messages = [];
...
var selectRoomState = /*#__PURE__*/createSelector([selectRoom], function (room) {
...
var selectIsInPreview = /*#__PURE__*/createSelector(selectRoomState, function (roomState) {
  return roomState === HMSRoomState.Preview;
});
var selectRoomStarted = /*#__PURE__*/createSelector(selectRoom, function (room) {
  return room.roomState !== HMSRoomState.Disconnected;
});
/**
...
var selectAvailableRoleNames = /*#__PURE__*/createSelector([selectRolesMap], function (rolesMap) {
...
var selectLocalPeerRole = /*#__PURE__*/createSelector([selectLocalPeer, selectRolesMap], function (localPeer, rolesMap) {
...
var selectIsAllowedToSubscribe = /*#__PURE__*/createSelector([selectLocalPeerRole], function (role) {
...
var selectPlaylist = function selectPlaylist(type) {
  ...
  return createSelector(selectPlaylistMap(type), function (storePlaylist) {
...
var selectPlaylistSelectedItem = function selectPlaylistSelectedItem(type) {
  ...
  return createSelector(selectPlaylistMap(type), selectPlaylistSelection(type), function (storePlaylist, currentSelection) {
...
var selectAudioPlaylist = {
  selection: /*#__PURE__*/selectPlaylistSelection(HMSPlaylistType.audio),
  progress: /*#__PURE__*/selectPlaylistProgress(HMSPlaylistType.audio),
  currentTime: /*#__PURE__*/selectPlaylistCurrentTime(HMSPlaylistType.audio),
  volume: /*#__PURE__*/selectPlaylistVolume(HMSPlaylistType.audio),
  list: /*#__PURE__*/selectPlaylist(HMSPlaylistType.audio),
  selectedItem: /*#__PURE__*/selectPlaylistSelectedItem(HMSPlaylistType.audio)
};
var selectVideoPlaylist = {
  selection: /*#__PURE__*/selectPlaylistSelection(HMSPlaylistType.video),
  progress: /*#__PURE__*/selectPlaylistProgress(HMSPlaylistType.video),
  currentTime: /*#__PURE__*/selectPlaylistCurrentTime(HMSPlaylistType.audio),
  volume: /*#__PURE__*/selectPlaylistVolume(HMSPlaylistType.video),
  list: /*#__PURE__*/selectPlaylist(HMSPlaylistType.video),
  selectedItem: /*#__PURE__*/selectPlaylistSelectedItem(HMSPlaylistType.video)
};
...
var HMSLogger = /*#__PURE__*/function () {
  ...
  HMSLogger.d = function d() {
    ...
    this.log.apply(this, [HMSLogLevel.DEBUG].concat(data));
  };
  ...
  HMSLogger.i = function i() {
    ...
    this.log.apply(this, [HMSLogLevel.INFO].concat(data));
  };
  ...
  HMSLogger.w = function w() {
    ...
    this.log.apply(this, [HMSLogLevel.WARN].concat(data));
  };
...
var selectPeerByIDBare = /*#__PURE__*/createSelector([selectPeersMap, selectPeerID], function (storePeers, peerID) {
  return peerID ? storePeers[peerID] : null;
});
var selectTrackByIDBare = /*#__PURE__*/createSelector([selectTracksMap, selectTrackID], function (storeTracks, trackID) {
...
var selectPeerNameByID = /*#__PURE__*/byIDCurry( /*#__PURE__*/createSelector(selectPeerByIDBare, function (peer) {
...
var selectTrackAudioByID = /*#__PURE__*/byIDCurry( /*#__PURE__*/createSelector(selectSpeakerByTrackID, function (speaker) {
...
var selectPeerAudioByID = /*#__PURE__*/byIDCurry( /*#__PURE__*/createSelector(selectSpeakerByPeerID, function (speaker) {
  return (speaker == null ? void 0 : speaker.audioLevel) || 0;
}));
/**
...
var selectVideoPlaylistVideoTrackByPeerID = /*#__PURE__*/byIDCurry( /*#__PURE__*/createSelector(selectTracksMap, selectPeerByIDBare, function (tracks, peer) {
  var trackID = peer == null ? void 0 : peer.auxiliaryTracks.find(function (trackID) {
    var track = tracks[trackID];
...
var selectVideoPlaylistAudioTrackByPeerID = /*#__PURE__*/byIDCurry( /*#__PURE__*/createSelector(selectTracksMap, selectPeerByIDBare, function (tracks, peer) {
  var trackID = peer == null ? void 0 : peer.auxiliaryTracks.find(function (trackID) {
    var track = tracks[trackID];
...
var selectAudioPlaylistTrackByPeerID = /*#__PURE__*/byIDCurry( /*#__PURE__*/createSelector(selectTracksMap, selectPeerByIDBare, function (tracks, peer) {
  var trackID = peer == null ? void 0 : peer.auxiliaryTracks.find(function (trackID) {
    var track = tracks[trackID];
...
var selectScreenSharesByPeerId = /*#__PURE__*/byIDCurry( /*#__PURE__*/createSelector(selectTracksMap, selectPeerByIDBare, function (tracks, peer) {
...
var selectScreenShareByPeerID = function selectScreenShareByPeerID(id) {
  return createSelector(selectScreenSharesByPeerId(id), function (screenshare) {
...
var selectMessagesByPeerIDInternal = /*#__PURE__*/createSelector([selectHMSMessages, selectLocalPeerID, selectPeerID], function (messages, localPeerID, peerID) {
  if (!peerID) {
    return undefined;
  }
...
var selectMessagesByRoleInternal = /*#__PURE__*/createSelector([selectHMSMessages, selectRoleName], function (messages, roleName) {
  if (!roleName) {
    return undefined;
  }
...
var selectBroadcastMessages = /*#__PURE__*/createSelector(selectHMSMessages, function (messages) {
  return messages.filter(function (message) {
...
var selectUnreadMessageCountByRole = /*#__PURE__*/createSelector([selectMessagesByRoleInternal, selectRoleName], function (messages) {
  if (!messages) {
    return 0;
  }
...
var selectUnreadMessageCountByPeerID = /*#__PURE__*/createSelector([selectMessagesByPeerIDInternal, selectPeerID], function (messages) {
  if (!messages) {
    return 0;
  }
...
var selectBroadcastMessagesUnreadCount = /*#__PURE__*/createSelector(selectBroadcastMessages, function (messages) {
  return messages.filter(function (m) {
    return !m.read;
  }).length;
});
...
var selectRoleChangeRequest = /*#__PURE__*/createSelector([selectRoleChangeStoreRequest, selectPeersMap, selectRolesMap], function (request, peersMap, rolesMap) {
  if (!request) {
    return null;
  }
...
var selectIsAllowedToPublish = /*#__PURE__*/createSelector([selectLocalPeerRole], function (role) {
...
var selectRoleByRoleName = function selectRoleByRoleName(roleName) {
  return createSelector([selectRolesMap], function (rolesMap) {
    return rolesMap[roleName];
  });
};
var selectLocalVideoPlugins = /*#__PURE__*/createSelector([selectLocalVideoTrackID, selectTracksMap], function (trackID, tracksMap) {
  var _track;
...
var selectLocalAudioPlugins = /*#__PURE__*/createSelector([selectLocalAudioTrackID, selectTracksMap], function (trackID, tracksMap) {
  var _track2;
...
var selectIsLocalVideoPluginPresent = function selectIsLocalVideoPluginPresent(pluginName) {
  return createSelector([selectLocalVideoPlugins], function (plugins) {
    return plugins.includes(pluginName);
  });
};
var selectIsLocalAudioPluginPresent = function selectIsLocalAudioPluginPresent(pluginName) {
  return createSelector([selectLocalAudioPlugins], function (plugins) {
    return plugins.includes(pluginName);
  });
};
      ...
      return runtime_1.wrap(function _callee9$(_context9) {
        while (1) {
          switch (_context9.prev = _context9.next) {
            ...
            case 16:
              type = enabled ? HMSTrackUpdate.TRACK_UNMUTED : HMSTrackUpdate.TRACK_MUTED;
...
var HMSNotifications = /*#__PURE__*/function () {
  ...
  _proto.sendDeviceChange = function sendDeviceChange(request) {
    ...
    var notification = this.createNotification(HMSNotificationTypes.DEVICE_CHANGE_UPDATE, request, request.error ? HMSNotificationSeverity.ERROR : HMSNotificationSeverity.INFO, "Selected " + request.type + " device - " + ((_request$selection = request.selection) == null ? void 0 : _request$selection.label));
  ...
  _proto.sendPeerUpdate = function sendPeerUpdate(type, peer) {
    ...
    if (notificationType) {
      var notification = this.createNotification(notificationType, hmsPeer, HMSNotificationSeverity.INFO);
      this.emitEvent(notification);
    }
  };
  ...
  _proto.sendTrackUpdate = function sendTrackUpdate(type, trackID) {
    ...
    if (notificationType) {
      var notification = this.createNotification(notificationType, hmsTrack, HMSNotificationSeverity.INFO);
      this.emitEvent(notification);
    }
  };

  _proto.sendMessageReceived = function sendMessageReceived(message) {
    var notification = this.createNotification(HMSNotificationTypes.NEW_MESSAGE, message, HMSNotificationSeverity.INFO);
    this.emitEvent(notification);
  };

  _proto.sendError = function sendError(error) {
    var notification = this.createNotification(HMSNotificationTypes.ERROR, error, HMSNotificationSeverity.ERROR);
    this.emitEvent(notification);
  };

  _proto.sendReconnecting = function sendReconnecting(error) {
    var notification = this.createNotification(HMSNotificationTypes.RECONNECTING, error, HMSNotificationSeverity.ERROR);
    this.emitEvent(notification);
  };

  _proto.sendReconnected = function sendReconnected() {
    var notification = this.createNotification(HMSNotificationTypes.RECONNECTED, null, HMSNotificationSeverity.INFO);
    this.emitEvent(notification);
  };

  _proto.sendChangeTrackStateRequest = function sendChangeTrackStateRequest(request) {
    var notification = this.createNotification(HMSNotificationTypes.CHANGE_TRACK_STATE_REQUEST, request, HMSNotificationSeverity.INFO);
    this.emitEvent(notification);
  };
